...
        connectionRef.current = null;
        ...
        // FIX: Only send the "hello" signal if we are the ANSWERER. 
...
      connectionRef.current = null;
    };
    // FIX: Removed userECDH and putEncr to prevent loop. Added amOfferer as it now influences signaling.
  }, [ws, user?.userId, otherUser?.userId, key, roomId, amOfferer, userECDH]);
